...
const DoingScreen = () => {
  const [tasks, setTasks] = useState([
    { id: "1", text: "Requirement Analysis & Planning", completed: false },
    { id: "2", text: "Software Development & Coding", completed: false },
    { id: "3", text: "Testing & Debugging", completed: false },
  ]);
